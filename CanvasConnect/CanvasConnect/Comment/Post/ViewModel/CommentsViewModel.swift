...
class CommentsViewModel: ObservableObject {
    ...
    func addComment(commentText: String, post: Post) {
        ...
        let comment = Comment(id: NSUUID().uuidString, comment: commentText, timestamp: Timestamp(), userId: currentUserID, postId: post.id)
    ...
    func fetchComments(for post: Post) {
        ...
        let query = commentsCollection.whereField("postId", isEqualTo: post.id)
